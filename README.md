...
### Acknowledgements
- I received inspiration for this project from my interest in IQ tests, [Bootstrap](https://getbootstrap.com/) and ongoing research online. I also used knowledge gained from the [Code Institute - Diploma in Software Development](https://www.codeinstitute.net/), [Stack Overflow](https://stackoverflow.com/) and [W3 Schools](https://www.w3schools.com/).
